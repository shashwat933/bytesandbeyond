    ...
    return (
        <>
            ...
            {loading && <div className='md2:w-128 flex justify-center   pt-8 my-4 mx-auto' >
                <div role="status">
                    <svg aria-hidden="true" class="w-8 h-10  mr-2 text-gray-200 animate-spin dark:text-white-600 fill-mine2" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
